...
def main():
    ...
    # holds constant.
    _, rows = dataset.split_for(profile, dataset.load(args.dataset), args.seed, args.experience, args.eval, holdout=args.holdout, upto_seq=args.upto_seq, n=args.rows)
