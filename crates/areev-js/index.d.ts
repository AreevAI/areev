...
export declare class Areev {
  constructor(path: string, ns?: string | undefined | null, passphrase?: string | undefined | null, actor?: string | undefined | null, telemetry?: string | undefined | null, principal?: string | undefined | null, indexText?: boolean | undefined | null, anonKey?: string | undefined | null, readOnly?: boolean | undefined | null)
  /**
   ...
   */
  triggerAdd(fieldsJson: string, because: string, ns?: string | undefined | null): Promise<string>
  /** Every trigger declaration in this namespace, newest first. JSON list. */
  triggerList(): Promise<string>
  /**
   ...
   */
  triggerStatus(): Promise<string>
  /** One trigger's state, by content address or a unique prefix of one. */
  triggerShow(trigger: string): Promise<string>
  /**
  ...
  triggerResume(trigger: string, because: string): Promise<string>
  /**
   ...
   * install.
   */
  triggerRender(target: string, db: string, exe?: string | undefined | null, extraArgs?: string | undefined | null): Promise<string>
}
