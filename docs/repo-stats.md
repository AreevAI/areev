...
v1.5.2 · 17 crates · 274 Rust files

| | |
|---|---|
| Source code | **77,441** lines |
| Test code | **45,086** lines (36.8% of all code) |
| Test functions | **2,227** |
| Line coverage | **80.1%** of 52,407 instrumented source lines |
| Stable error codes | **91** |
| Reference docs | 51 files, 21,001 lines |

## By crate

| Crate | Files | Source | Test | Tests |
|---|---:|---:|---:|---:|
| `areev-cal` | 39 | 23,834 | 18,193 | 979 |
| `areev-store` | 38 | 9,452 | 5,136 | 248 |
| `areev-core` | 48 | 8,100 | 3,878 | 255 |
| `areev-cli` | 18 | 5,657 | 5,549 | 165 |
| `areev-loop` | 34 | 7,858 | 1,187 | 137 |
| `areev-run` | 20 | 4,101 | 2,771 | 91 |
| `areev-context` | 8 | 1,899 | 2,421 | 90 |
| `areev-trigger` | 12 | 1,646 | 2,000 | 114 |
| `areev-run-core` | 8 | 1,934 | 969 | 31 |
| `areev-llm` | 8 | 1,764 | 844 | 44 |
| `areev-js` | 2 | 2,494 | 0 | 0 |
| `areev-server` | 3 | 1,431 | 1,024 | 35 |
| `areev-py` | 2 | 2,123 | 0 | 0 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 159,599 |
| Source code (no blanks or comments) | 77,441 |
| Unit test code (`#[cfg(test)]` blocks) | 21,594 |
| Integration test code (`tests/`, `benches/`) | 23,492 |
