...
v1.6.1 · 17 crates · 274 Rust files

| | |
|---|---|
| Source code | **78,781** lines |
| Test code | **47,232** lines (37.5% of all code) |
| Test functions | **2,306** |
| Line coverage | **81.0%** of 54,914 instrumented source lines |
| Stable error codes | **91** |
| Reference docs | 53 files, 22,612 lines |
...
| `areev-cli` | 18 | 5,583 | 5,510 | 164 |
| `areev-run` | 20 | 5,182 | 4,652 | 145 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 164,588 |
| Source code (no blanks or comments) | 78,781 |
| Unit test code (`#[cfg(test)]` blocks) | 22,084 |
| Integration test code (`tests/`, `benches/`) | 25,148 |
