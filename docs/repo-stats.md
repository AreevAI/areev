...
v1.7.2 · 17 crates · 292 Rust files

| | |
|---|---|
| Source code | **88,252** lines |
| Test code | **52,623** lines (37.4% of all code) |
| Test functions | **2,575** |
| Line coverage | **81.1%** of 57,966 instrumented source lines |
| Stable error codes | **96** |
| Reference docs | 57 files, 25,880 lines |
...
| `areev-store` | 40 | 10,134 | 5,466 | 275 |
| `areev-core` | 51 | 8,818 | 4,455 | 296 |
| `areev-cli` | 19 | 6,248 | 5,737 | 174 |
| `areev-run` | 20 | 5,557 | 5,271 | 162 |
| `areev-loop` | 34 | 9,367 | 1,371 | 163 |
| `areev-bench` | 18 | 6,111 | 2,585 | 104 |
...
| `areev-conformance` | 16 | 1,672 | 353 | 12 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 185,350 |
| Source code (no blanks or comments) | 88,252 |
| Unit test code (`#[cfg(test)]` blocks) | 25,677 |
| Integration test code (`tests/`, `benches/`) | 26,946 |
