...
v1.4.0 · 17 crates · 267 Rust files

| | |
|---|---|
| Source code | **75,582** lines |
| Test code | **42,870** lines (36.2% of all code) |
| Test functions | **2,152** |
| Line coverage | **80.1%** of 52,407 instrumented source lines |
| Stable error codes | **89** |
| Reference docs | 47 files, 19,776 lines |

## By crate

| Crate | Files | Source | Test | Tests |
|---|---:|---:|---:|---:|
| `areev-cal` | 39 | 23,616 | 17,782 | 965 |
| `areev-store` | 38 | 9,452 | 5,136 | 248 |
| `areev-core` | 47 | 8,011 | 3,827 | 251 |
| `areev-cli` | 15 | 5,167 | 4,855 | 149 |
| `areev-loop` | 33 | 7,534 | 1,079 | 129 |
| `areev-run` | 20 | 3,978 | 2,621 | 86 |
...
| `areev-server` | 3 | 1,418 | 918 | 31 |
| `areev-py` | 2 | 1,988 | 0 | 0 |
| `areev-conformance` | 14 | 1,371 | 343 | 12 |
| `areev-bench` | 9 | 1,696 | 36 | 3 |
| `areev-loop-adapter` | 6 | 883 | 735 | 23 |
| `areev-mcp` | 1 | 1,105 | 0 | 0 |

## Composition

| | |
|---|---:|
| Physical lines (all Rust) | 154,061 |
| Source code (no blanks or comments) | 75,582 |
| Unit test code (`#[cfg(test)]` blocks) | 21,110 |
| Integration test code (`tests/`, `benches/`) | 21,760 |
