...
v1.6.5 · 17 crates · 277 Rust files

| | |
|---|---|
| Source code | **80,571** lines |
| Test code | **48,907** lines (37.8% of all code) |
| Test functions | **2,386** |
| Line coverage | **81.0%** of 54,914 instrumented source lines |
| Stable error codes | **95** |
| Reference docs | 53 files, 23,767 lines |
...
| | |
|---|---:|
| Physical lines (all Rust) | 169,932 |
| Source code (no blanks or comments) | 80,571 |
| Unit test code (`#[cfg(test)]` blocks) | 22,607 |
