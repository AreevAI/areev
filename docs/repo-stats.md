...
v1.8.5 · 17 crates · 316 Rust files

| | |
|---|---|
| Source code | **101,887** lines |
| Test code | **61,455** lines (37.6% of all code) |
| Test functions | **2,878** |
| Line coverage | **82.3%** of 62,893 instrumented source lines |
| Stable error codes | **103** |
| Reference docs | 64 files, 32,283 lines |
...
| `areev-run-core` | 8 | 2,396 | 1,300 | 47 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 215,931 |
| Source code (no blanks or comments) | 101,887 |
| Unit test code (`#[cfg(test)]` blocks) | 28,271 |
| Integration test code (`tests/`, `benches/`) | 33,184 |
