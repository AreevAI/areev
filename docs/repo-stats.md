...
v1.7.1 · 17 crates · 290 Rust files

| | |
|---|---|
| Source code | **87,915** lines |
| Test code | **52,523** lines (37.4% of all code) |
| Test functions | **2,565** |
| Line coverage | **81.1%** of 57,966 instrumented source lines |
| Stable error codes | **96** |
| Reference docs | 44 files, 19,163 lines |
...
| `areev-bench` | 18 | 5,983 | 2,585 | 104 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 184,822 |
| Source code (no blanks or comments) | 87,915 |
