...
v1.5.0 · 17 crates · 270 Rust files

| | |
|---|---|
| Source code | **76,783** lines |
| Test code | **43,949** lines (36.4% of all code) |
| Test functions | **2,183** |
| Line coverage | **80.1%** of 52,407 instrumented source lines |
| Stable error codes | **89** |
| Reference docs | 47 files, 20,247 lines |

## By crate

| Crate | Files | Source | Test | Tests |
|---|---:|---:|---:|---:|
| `areev-cal` | 39 | 23,749 | 17,901 | 969 |
| `areev-store` | 38 | 9,452 | 5,136 | 248 |
| `areev-core` | 47 | 8,059 | 3,848 | 252 |
| `areev-cli` | 17 | 5,511 | 5,407 | 159 |
| `areev-loop` | 34 | 7,858 | 1,187 | 137 |
| `areev-run` | 20 | 4,079 | 2,771 | 91 |
| `areev-context` | 8 | 1,899 | 2,421 | 90 |
| `areev-trigger` | 10 | 1,365 | 1,367 | 92 |
| `areev-run-core` | 8 | 1,934 | 969 | 31 |
| `areev-llm` | 8 | 1,764 | 844 | 44 |
| `areev-js` | 2 | 2,457 | 0 | 0 |
| `areev-server` | 3 | 1,435 | 984 | 32 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 156,973 |
| Source code (no blanks or comments) | 76,783 |
| Unit test code (`#[cfg(test)]` blocks) | 21,286 |
| Integration test code (`tests/`, `benches/`) | 22,663 |
