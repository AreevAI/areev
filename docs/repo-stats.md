...
v1.6.3 · 17 crates · 275 Rust files

| | |
|---|---|
| Source code | **79,789** lines |
| Test code | **48,046** lines (37.6% of all code) |
| Test functions | **2,343** |
| Line coverage | **81.0%** of 54,914 instrumented source lines |
| Stable error codes | **92** |
| Reference docs | 53 files, 23,212 lines |
...
| `areev-store` | 39 | 9,875 | 5,236 | 262 |
| `areev-core` | 49 | 8,575 | 4,292 | 284 |
...
| `areev-conformance` | 14 | 1,371 | 353 | 12 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 167,287 |
| Source code (no blanks or comments) | 79,789 |
| Unit test code (`#[cfg(test)]` blocks) | 22,301 |
| Integration test code (`tests/`, `benches/`) | 25,745 |
