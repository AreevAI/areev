...
v1.8.0 · 17 crates · 306 Rust files

| | |
|---|---|
| Source code | **95,833** lines |
| Test code | **57,130** lines (37.3% of all code) |
| Test functions | **2,726** |
| Line coverage | **82.3%** of 62,893 instrumented source lines |
| Stable error codes | **99** |
| Reference docs | 62 files, 29,783 lines |
...
| `areev-store` | 40 | 11,158 | 5,796 | 292 |
| `areev-core` | 51 | 8,870 | 4,514 | 301 |
| `areev-cli` | 22 | 7,394 | 6,704 | 195 |
| `areev-run` | 22 | 6,360 | 6,271 | 187 |
...
| `areev-conformance` | 21 | 1,926 | 925 | 21 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 201,996 |
| Source code (no blanks or comments) | 95,833 |
| Unit test code (`#[cfg(test)]` blocks) | 26,807 |
| Integration test code (`tests/`, `benches/`) | 30,323 |
