...
v1.7.3 · 17 crates · 302 Rust files

| | |
|---|---|
| Source code | **94,793** lines |
| Test code | **56,304** lines (37.3% of all code) |
| Test functions | **2,705** |
| Line coverage | **81.8%** of 62,453 instrumented source lines |
| Stable error codes | **99** |
| Reference docs | 62 files, 29,506 lines |
...
| | |
|---|---:|
| Physical lines (all Rust) | 199,636 |
| Source code (no blanks or comments) | 94,793 |
| Unit test code (`#[cfg(test)]` blocks) | 26,697 |
| Integration test code (`tests/`, `benches/`) | 29,607 |
