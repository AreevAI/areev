...
v1.8.3 · 17 crates · 310 Rust files

| | |
|---|---|
| Source code | **98,128** lines |
| Test code | **59,278** lines (37.7% of all code) |
| Test functions | **2,805** |
| Line coverage | **82.3%** of 62,893 instrumented source lines |
| Stable error codes | **103** |
| Reference docs | 64 files, 31,605 lines |
...
| `areev-mcp` | 1 | 1,232 | 0 | 0 |

## Composition

| | |
|---|---:|
| Physical lines (all Rust) | 208,578 |
| Source code (no blanks or comments) | 98,128 |
| Unit test code (`#[cfg(test)]` blocks) | 27,497 |
| Integration test code (`tests/`, `benches/`) | 31,781 |
