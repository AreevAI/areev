...
v1.8.5 · 17 crates · 314 Rust files

| | |
|---|---|
| Source code | **101,319** lines |
| Test code | **60,698** lines (37.5% of all code) |
| Test functions | **2,865** |
| Line coverage | **82.3%** of 62,893 instrumented source lines |
| Stable error codes | **103** |
| Reference docs | 64 files, 32,093 lines |
...
| | |
|---|---:|
| Physical lines (all Rust) | 214,354 |
| Source code (no blanks or comments) | 101,319 |
| Unit test code (`#[cfg(test)]` blocks) | 28,112 |
