...
v1.3.1 · 17 crates · 267 Rust files

| | |
|---|---|
| Source code | **75,356** lines |
| Test code | **42,755** lines (36.2% of all code) |
| Test functions | **2,149** |
| Line coverage | **80.1%** of 52,407 instrumented source lines |
| Stable error codes | **89** |
| Reference docs | 47 files, 19,543 lines |
...
| | |
|---|---:|
| Physical lines (all Rust) | 153,626 |
| Source code (no blanks or comments) | 75,356 |
| Unit test code (`#[cfg(test)]` blocks) | 21,068 |
| Integration test code (`tests/`, `benches/`) | 21,687 |
