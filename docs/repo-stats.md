...
v1.6.5 · 17 crates · 288 Rust files

| | |
|---|---|
| Source code | **85,685** lines |
| Test code | **51,513** lines (37.5% of all code) |
| Test functions | **2,513** |
| Line coverage | **81.0%** of 54,914 instrumented source lines |
| Stable error codes | **96** |
| Reference docs | 56 files, 25,166 lines |
...
| | |
|---|---:|
| Physical lines (all Rust) | 180,292 |
| Source code (no blanks or comments) | 85,685 |
| Unit test code (`#[cfg(test)]` blocks) | 25,056 |
| Integration test code (`tests/`, `benches/`) | 26,457 |
