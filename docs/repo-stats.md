...
v1.6.5 · 17 crates · 283 Rust files

| | |
|---|---|
| Source code | **82,944** lines |
| Test code | **50,101** lines (37.7% of all code) |
| Test functions | **2,435** |
| Line coverage | **81.0%** of 54,914 instrumented source lines |
| Stable error codes | **95** |
| Reference docs | 53 files, 23,795 lines |
...
| `areev-store` | 40 | 10,083 | 5,411 | 273 |
| `areev-core` | 49 | 8,587 | 4,295 | 284 |
| `areev-run` | 20 | 5,557 | 5,271 | 162 |
| `areev-cli` | 18 | 5,869 | 5,593 | 167 |
| `areev-loop` | 34 | 7,864 | 1,217 | 139 |
| `areev-bench` | 15 | 4,063 | 1,200 | 50 |
...
| `areev-conformance` | 15 | 1,490 | 353 | 12 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 174,274 |
| Source code (no blanks or comments) | 82,944 |
| Unit test code (`#[cfg(test)]` blocks) | 23,801 |
| Integration test code (`tests/`, `benches/`) | 26,300 |
