...
v1.7.2 · 17 crates · 293 Rust files

| | |
|---|---|
| Source code | **89,197** lines |
| Test code | **52,670** lines (37.1% of all code) |
| Test functions | **2,584** |
| Line coverage | **81.1%** of 57,966 instrumented source lines |
| Stable error codes | **96** |
| Reference docs | 57 files, 25,989 lines |
...
| | |
|---|---:|
| Physical lines (all Rust) | 186,599 |
| Source code (no blanks or comments) | 89,197 |
| Unit test code (`#[cfg(test)]` blocks) | 25,720 |
| Integration test code (`tests/`, `benches/`) | 26,950 |
