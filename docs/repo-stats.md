...
v1.7.3 · 17 crates · 304 Rust files
...
| `areev-store` | 40 | 10,900 | 5,780 | 291 |
| `areev-core` | 51 | 8,870 | 4,514 | 301 |
| `areev-cli` | 22 | 7,394 | 6,701 | 195 |
...
| `areev-conformance` | 19 | 1,849 | 838 | 20 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 201,438 |
| Source code (no blanks or comments) | 95,498 |
| Unit test code (`#[cfg(test)]` blocks) | 26,791 |
| Integration test code (`tests/`, `benches/`) | 30,233 |
