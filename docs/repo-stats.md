...
v1.6.5 · 17 crates · 286 Rust files

| | |
|---|---|
| Source code | **85,003** lines |
| Test code | **51,322** lines (37.6% of all code) |
| Test functions | **2,504** |
| Line coverage | **81.0%** of 54,914 instrumented source lines |
| Stable error codes | **95** |
| Reference docs | 55 files, 24,923 lines |
...
| `areev-store` | 40 | 10,022 | 5,386 | 272 |
| `areev-core` | 50 | 8,773 | 4,414 | 290 |
| `areev-cli` | 18 | 6,245 | 5,593 | 167 |
| `areev-run` | 20 | 5,557 | 5,271 | 162 |
| `areev-loop` | 34 | 7,864 | 1,217 | 139 |
| `areev-bench` | 16 | 4,834 | 1,969 | 89 |
...
| | |
|---|---:|
| Physical lines (all Rust) | 178,980 |
| Source code (no blanks or comments) | 85,003 |
| Unit test code (`#[cfg(test)]` blocks) | 25,022 |
