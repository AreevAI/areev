...
v1.8.3 · 17 crates · 311 Rust files

| | |
|---|---|
| Source code | **99,621** lines |
| Test code | **59,908** lines (37.6% of all code) |
| Test functions | **2,844** |
| Line coverage | **82.3%** of 62,893 instrumented source lines |
| Stable error codes | **103** |
| Reference docs | 64 files, 31,833 lines |
...
| `areev-loop` | 35 | 13,164 | 1,897 | 231 |
| `areev-cli` | 22 | 7,696 | 7,268 | 205 |
| `areev-run` | 23 | 6,529 | 6,973 | 206 |
| `areev-core` | 51 | 8,917 | 4,615 | 307 |
| `areev-bench` | 20 | 6,586 | 2,831 | 111 |
| `areev-trigger` | 13 | 2,023 | 2,624 | 131 |
| `areev-server` | 3 | 2,224 | 1,629 | 80 |
| `areev-context` | 8 | 1,918 | 2,481 | 94 |
| `areev-run-core` | 8 | 2,389 | 1,300 | 47 |
| `areev-conformance` | 22 | 2,135 | 983 | 22 |
| `areev-js` | 2 | 2,917 | 0 | 0 |
| `areev-llm` | 8 | 1,847 | 924 | 48 |
| `areev-py` | 2 | 2,485 | 0 | 0 |
| `areev-loop-adapter` | 7 | 990 | 984 | 36 |
| `areev-mcp` | 1 | 1,236 | 0 | 0 |

## Composition

| | |
|---|---:|
| Physical lines (all Rust) | 211,308 |
| Source code (no blanks or comments) | 99,621 |
| Unit test code (`#[cfg(test)]` blocks) | 27,788 |
| Integration test code (`tests/`, `benches/`) | 32,120 |
